    ...
    return (
      <TouchableWithoutFeedback onPress={() => this._onPress()}>
        <Animatable.View ref='view' style={{
          margin: 10, paddingTop: 10, paddingBottom: 10, paddingRight: 20, paddingLeft: 20, backgroundColor: this.state.status ? this.props.onColor : '#bdbdbd', borderRadius: 20, justifyContent: 'center',
          alignItems: 'center', }}>
